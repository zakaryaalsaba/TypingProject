<template>
        ...
        <div class="lesson-text">
          ...
          <p class="instruction">
            {{ isLessonComplete 
              ...
              : 'Press the , key with your right middle finger'
            }}
          </p>
          <p class="finger-movement-tip">
            <span class="movement-arrow">↓</span> 
            Move right middle finger down from home position (k) to ,
          </p>
  ...
  export default {
    ...
    methods: {
      ...
      goToNextLesson() {
        this.$router.push('/lessons/PeriodKeyLesson');
      }
    }
  }
  </script>