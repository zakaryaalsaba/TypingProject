  ...
  <div class="lesson-container">
    <div class="lesson-text">
      ...
      <p class="finger-movement-tip">
        ...
        {{ isOriginalPair 
          ? 'Move left index finger down from home position (f) to v and b'
      ...
      <div v-if="isLessonComplete" class="button-container">
        <LessonNavigation 
          nextLessonKey="Next Lesson: V B N Keys"
...
export default {
  ...
  methods: {
    ...
    goToNextLesson() {
      this.$router.push('/lessons/VBNKeyLesson')
    }
  }
}
</script>
