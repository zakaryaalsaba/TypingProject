<template>
  <div class="a-key-lesson">
    <div class="lesson-container">
      <div class="lesson-text">
        <h2>Lesson 4: The a Key</h2>
        <p class="instruction">
          {{ isLessonComplete 
            ? 'Lesson complete! Choose your next step.' 
            : 'Place your left pinky finger on the A key and practice pressing it.' 
          }}
        </p>
        <p class="target-key" :class="{ 'completed': isLessonComplete }">
          {{ isLessonComplete ? '✓ Complete!' : 'Press: a' }}
        </p>
...
export default {
  ...
  methods: {
    ...
    goToNextLesson() {
      this.$router.push('/lessons/SemicolonKeyLesson')
    }
  }
}
</script>
